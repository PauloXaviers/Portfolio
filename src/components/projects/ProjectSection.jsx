import { projectDetails, cardsProjects } from "../../contents/projectsData.js";
    ...
    <section className="w-[80%] flex-col flex justify-center items-center mt-15 lg:mt-0 gap-5 min-h-screen">
      ...
      >
        {contentList.map((item) => (
          ...
          >
            <Card.Content
              className={`${isHome ? cardClass.home : cardClass.project}`}
            >
                  ...
                  {item.techList.map((tech) => (
                    ...
                    >
                      <img
                        src={tech.imgUrl}
                        className="w-8"
                        alt="Imagem do icone da técnologia"
                      />
                      <p className="text-white font-extralight text-[13px]">
                        {tech.name}
                      </p>
                    </div>
                  ))}
