    ...
    <section className="flex flex-col gap-5 w-[80%] items-center justify-center h-auto mt-35 lg:mt-0 lg:h-screen">
      <div className="w-full flex flex-wrap justify-center items-center gap-10 md:gap-5">
        <div className="flex flex-col gap-5 w-full lg:w-[60%]">
          ...
          <h2 className="text-white text-xl md:text-3xl xl:text-5xl ">
            Criando experiências digitais com código.
          </h2>
          <p className="text-white font-extralight md:font-light text-[12px] md:text-[15px]">
      ...
      <div className="flex flex-row items-center justify-center gap-7 mt-10">
        <ActionButton
          className="w-40 md:w-56 p-3 rounded-2xl text-[10px] md:text-[13px] gap-5 flex flex-nowrap justify-center items-center whitespace-nowrap text-center hover:scale-105 active:scale-95 transition-all duration-150"
          text="Download CV"
        ...
        <ActionButton
          className="w-40 md:w-56 rounded-2xl text-[10px] md:text-[13px] p-3 gap-5 flex flex-nowrap justify-center items-center whitespace-nowrap text-center hover:scale-105 active:scale-95 transition-all duration-150"
